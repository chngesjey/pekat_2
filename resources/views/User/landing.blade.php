...
@section('title', 'TS - Tempat Sambat ')
...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">   
                <a class="navbar-brand" href="/">
                    <h4 class="semi-bold mb-0 text-white">TS</h4>
                    <p class="italic mt-0 text-white">Tempat Sambat</p>
                </a>
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Masyarakat Untuk Sambat</h2>
        <p class="italic text-white mb-5">Sampaikan Sambatan Anda Disini Sekarang !!</p>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <div class="card mb-3">Tulis Sambatan Disini</div>
            <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ old('judul_laporan') }}" name="judul_laporan"
                        placeholder="Masukkan Judul Sambatan" class="form-control">
                </div>
                <div class="form-group">
...
<div class="pengaduan mt-5">
    <div class="bg-purple">
        <div class="text-center">
            <h5 class="medium text-white mt-3">JUMLAH SAMBATAN SEKARANG</h5>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Anandito • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
